            ...
            if event.type == pygame.QUIT:
                ...
                if event.button == 1:  # Left mouse button
                    ...
                    if territory.owner == players[player_turn] and mx_troops > 0 and not phase:
                        ...
                        selected_attacker = None
                    elif phase and territory.owner is None and selected_attacker is not None and selected_attacker.is_adjacent(territory):
                        paul_muadib_atreides_snake_game(selected_attacker, territory)
